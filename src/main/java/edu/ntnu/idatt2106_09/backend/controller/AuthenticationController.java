...
public class AuthenticationController {
    ...
    @Operation(summary = "Register a new user", description = "Register a new user and return an authentication response containing user information and access/refresh tokens")
     ...
     */
     ...
     @Operation(summary = "Authenticate a user", description = "Authenticate a user and return an authentication response containing user information and access/refresh tokens")
    ...
    @Operation(summary = "Refresh access token", description = "Handle a token refresh request and update the response with a new access token")
